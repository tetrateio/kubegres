...
func (r *TestResourceCreator) CreateSecret() {
	...
	resourceToCreate := resourceConfigs2.LoadSecretYaml()
	resourceToCreate.Namespace = r.namespace
	r.createResourceFromYaml("Secret", resourceConfigs2.SecretResourceName, &existingResource, &resourceToCreate)
}

func (r *TestResourceCreator) CreateBackUpPvc() {
	existingResource := v1.PersistentVolumeClaim{}
	resourceToCreate := resourceConfigs2.LoadBackUpPvcYaml()
	resourceToCreate.Namespace = r.namespace
	r.createResourceFromYaml("BackUp PVC", resourceConfigs2.BackUpPvcResourceName, &existingResource, resourceToCreate)
}

func (r *TestResourceCreator) CreateBackUpPvc2() {
	existingResource := v1.PersistentVolumeClaim{}
	resourceToCreate := resourceConfigs2.LoadBackUpPvcYaml()
	resourceToCreate.Name = resourceConfigs2.BackUpPvcResourceName2
	resourceToCreate.Namespace = r.namespace
	r.createResourceFromYaml("BackUp PVC 2", resourceConfigs2.BackUpPvcResourceName2, &existingResource, resourceToCreate)
}

func (r *TestResourceCreator) CreateConfigMapEmpty() {
	existingResource := v1.ConfigMap{}
	resourceToCreate := resourceConfigs2.LoadCustomConfigMapYaml(resourceConfigs2.CustomConfigMapEmptyYamlFile)
	resourceToCreate.Namespace = r.namespace
	r.createResourceFromYaml("Custom ConfigMap empty", resourceConfigs2.CustomConfigMapEmptyResourceName, &existingResource, &resourceToCreate)
}
...
func (r *TestResourceCreator) CreateNamespace() {
	...
	r.createResourceFromYaml("Custom Namespace", resourceConfigs2.CustomConfigMapWithPrimaryInitScriptResourceName, &existingResource, &resourceToCreate)
}

func (r *TestResourceCreator) CreateConfigMapWithPrimaryInitScript() {
	existingResource := v1.ConfigMap{}
	resourceToCreate := resourceConfigs2.LoadCustomConfigMapYaml(resourceConfigs2.CustomConfigMapWithPrimaryInitScriptYamlFile)
	resourceToCreate.Namespace = r.namespace
...
func (r *TestResourceCreator) loadYamlServiceToSqlQueryDb(isPrimaryDb bool) v1.Service {
	if isPrimaryDb {
		return resourceConfigs2.LoadYamlServiceToSqlQueryPrimaryDb()
	}
	return resourceConfigs2.LoadYamlServiceToSqlQueryReplicaDb()
}
